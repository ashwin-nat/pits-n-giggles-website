---
title: "Remote Race Engineering - Using Radmin"
...
Want to bring a real-time **race engineer** into your sim racing experience-even if they're in a different city or country? With *Pits n' Giggles* and a virtual LAN tool like **Radmin**, you can stream **UDP telemetry** from your racing game (like **F1 25 telemetry**) to your engineer over the internet-**without them needing to join your game lobby**.
...
- **VPN software:**
  - Recommended: [Radmin](https://www.radmin-vpn.com/)
...
To simulate being on the same local network, install **Radmin** or another VPN tool on both the **driver** and **engineer** machines.
And then click on the giant *ON* button
...
- The **Driver** creates a new network in Radmin. (Network -> Create Network). Choose a unique network name and a password
<Image
  src={radminCreateNetwork}
  alt="Radmin Create Network"
  widths={[300, 600, 1200]}
  sizes="(max-width: 768px) 100vw, 768px"/>

- The **Engineer** joins that same network using the same network ID and password.
<Image
  src={radminJoinNetwork}
  alt="Radmin Create Network"
  widths={[300, 600, 1200]}
  sizes="(max-width: 768px) 100vw, 768px"/>

- Now you should be able to see 2 devices in the same network. Share your Radmin IP address with your engineer
<Image
  src={radminMainUINoMenu}
  alt="Radmin Create Network"
  widths={[300, 600, 1200]}
  sizes="(max-width: 768px) 100vw, 768px"/>

[For those who prefer a video tutorial](https://www.youtube.com/watch?v=Au8emZkprDk)
**NOTE**: Ignore the part from 2:00 minutes onwards. What we're interested in is covered in the first two minutes of the video
...
This is your **localhost IP**-but for remote access, use your Radmin IP address.

---

## 3️⃣ Engineer Connects to Your Radmin IP
...
<Image
  src={connectedToRemoteDashboard}
  alt="Connected to Remote Dashboard"
  widths={[300, 600, 1200]}
  sizes="(max-width: 768px) 100vw, 768px"/>
...
- Engineer can’t connect?
  ...
  - Test by pinging your Radmin IP.
