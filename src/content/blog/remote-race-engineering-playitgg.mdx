...
image: '../../blog_assets/remote-race-engineer/thumbnail.webp'
...
import liveTelemetry from '../../blog_assets/common/main-ui.png';
import playitSetupStatus from '../../blog_assets/remote-race-engineer/playit-setup-steps.png';
import playitTunnelSetup from '../../blog_assets/remote-race-engineer/playit-setup-tunnel.png';
import playitTunnelRename from '../../blog_assets/remote-race-engineer/playit-tunnel-rename.png';
import playitTunnelStatus from '../../blog_assets/remote-race-engineer/playit-tunnel-status.png';
...
<Image
  src={playitSetupStatus}
  alt="Playit.gg setup status"
  widths={[300, 600, 1200]}
  sizes="(max-width: 768px) 100vw, 768px"/>
...
<Image
  src={playitTunnelStatus}
  alt="Playit.gg tunnel status"
  widths={[300, 600, 1200]}
  sizes="(max-width: 768px) 100vw, 768px"/>
